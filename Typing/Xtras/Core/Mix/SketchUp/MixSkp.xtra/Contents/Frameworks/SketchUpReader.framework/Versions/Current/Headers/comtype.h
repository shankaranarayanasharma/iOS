// $Header: /home/cvs/refactor/source/sketchup/macwin/comtype.h,v 1.4 2005/04/20 09:25:13 joee Exp $
//=============================================================================
...
#elif __LINUX__
class CString;
typedef CString *BSTR;  // Ryan marked this "FIXME" with no explanation.
#endif
#define BSTR_DEFINED
#endif
